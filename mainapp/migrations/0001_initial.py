    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to=mainapp.models.get_file_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.CharField(max_length=150)),
                ('name', models.CharField(max_length=150)),
                ('product_image', models.ImageField(blank=True, null=True, upload_to=mainapp.models.get_file_path)),
                ('small_description', models.CharField(max_length=150)),
                ('description', models.TextField(max_length=500)),
                ('quantity', models.IntegerField()),
                ('orginial_price', models.IntegerField()),
